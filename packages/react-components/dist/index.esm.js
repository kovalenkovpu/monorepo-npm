...
var Button = function (_a) {
    ...
    return (jsx("button", __assign({}, rest, { className: computedClasses }, { children: children }), void 0));
};
...
var Card = function (_a) {
    ...
    return (jsx("section", __assign({ onClick: onClick, className: classes.card }, { children: children }), void 0));
};
